namespace Helper
{
	public class GlobalHelper
	{
        ...
        #endregion
        #region AppSettings   	
        public static int DanhMucATTPXepLoaiIDDat
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucATTPXepLoaiIDDat").Value);
            }
        }
        public static int DanhMucATTPXepLoaiIDKhongDat
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucATTPXepLoaiIDKhongDat").Value);
            }
        }
        
        public static string MauNen
		{
			get
			{
				var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
				return builder.Build().GetSection("AppSettings").GetSection("MauNen").Value;
			}
		}		
        ...
        public static string KyThay
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return builder.Build().GetSection("AppSettings").GetSection("KyThay").Value;
            }
        }        
        public static string StateAgencyParentName
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return builder.Build().GetSection("AppSettings").GetSection("StateAgencyParentName").Value;
            }
        }
        ...
        public static int AnToanThucPhamGiayChungNhanThoiHanThang
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("AnToanThucPhamGiayChungNhanThoiHanThang").Value);
            }
        }
        public static int DanhMucBienBanATTPIDATTPThamDinh
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucBienBanATTPIDATTPThamDinh").Value);
            }
        }
        public static int StateAgencyID
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("StateAgencyID").Value);
            }
        }
        public static int DanhMucATTPLoaiHoSoID
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucATTPLoaiHoSoID").Value);
            }
        }
        public static int DanhMucATTPTinhTrangID
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucATTPTinhTrangID").Value);
            }
        }
        public static int DanhMucATTPXepLoaiID
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucATTPXepLoaiID").Value);
            }
        }
        public static int ProvinceDataIDBenTre
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("ProvinceDataIDBenTre").Value);
            }
        }
        public static long PlanTypeIDDangKyATTP
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDDangKyATTP").Value);
            }
        }
        public static long PlanTypeIDThamDinhATTP
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDThamDinhATTP").Value);
            }
        }
        public static long PlanTypeIDCoSoNuoi
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDCoSoNuoi").Value);
            }
        }
        public static long PlanTypeIDCamKet17
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDCamKet17").Value);
            }
        }
        public static long PlanTypeIDGiamSatDuLuong
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDGiamSatDuLuong").Value);
            }
        }
        public static long PlanTypeIDNhuyenThe02ManhVo
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDNhuyenThe02ManhVo").Value);
            }
        }
        public static long PlanTypeIDDangKyMaDongGoi
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDDangKyMaDongGoi").Value);
            }
        }
        public static long PlanTypeIDDangKyMaVungTrong
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("PlanTypeIDDangKyMaVungTrong").Value);
            }
        }
        public static int DanhMucThanhVienIDDoanhNghiep
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucThanhVienIDDoanhNghiep").Value);
            }
        }
        public static int DanhMucThanhVienIDNhanVien
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucThanhVienIDNhanVien").Value);
            }
        }
        public static int DanhMucThanhVienIDKhachMoi
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucThanhVienIDKhachMoi").Value);
            }
        }
        public static int ProductUnitIDTan
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return int.Parse(builder.Build().GetSection("AppSettings").GetSection("ProductUnitIDTan").Value);
            }
        }
		...
		public static string MongodbServerConectionString
		{
			get
			{
				var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
				return builder.Build().GetSection("AppSettings").GetSection("MongodbServerConectionString").Value;
			}
		}
        ...
        public static long DanhMucNgonNguID
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return long.Parse(builder.Build().GetSection("AppSettings").GetSection("DanhMucNgonNguID").Value);
            }
        }
        ...
        public static string GiayChungNhanDuDieuKienAnToanThucPham_MaSo
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return builder.Build().GetSection("AppSettings").GetSection("GiayChungNhanDuDieuKienAnToanThucPham_MaSo").Value;
            }
        }
        ...
        public static string FCMProjectID
        {
            ...
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return builder.Build().GetSection("AppSettings").GetSection("FCMProjectID").Value;
            }
        }
        public static string FCMFileJSON
        {
            get
            {
                var builder = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                return builder.Build().GetSection("AppSettings").GetSection("FCMFileJSON").Value;
            }
        }
        #endregion
        #region Functions
