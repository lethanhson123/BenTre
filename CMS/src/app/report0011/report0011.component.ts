...
@Component({
  selector: 'app-report0011',
  templateUrl: './report0011.component.html',
  styleUrls: ['./report0011.component.css']
})
export class Report0011Component implements OnInit {
  ...
  Report0011Search() {
    ...
    this.ReportService.Report0011ToListAsync().subscribe(
      res => {
  ...
  Report0011Download() {
    ...
    this.DownloadService.ExportReport0011ToExcelAsync().subscribe(
      res => {
