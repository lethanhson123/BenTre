...
@Component({
  selector: 'app-co-so-map-detail',
  templateUrl: './co-so-map-detail.component.html',
  styleUrls: ['./co-so-map-detail.component.css']
})
export class CoSoMapDetailComponent implements OnInit {

  domainURL: string = environment.DomainURL;

  constructor(
    private dialog: MatDialog,
    public dialogRef: MatDialogRef<CoSoMapDetailComponent>,
