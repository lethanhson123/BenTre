...
@Component({
  selector: 'app-plan-tham-dinh-detail-giam-sat-du-luong001',
  templateUrl: './plan-tham-dinh-detail-giam-sat-du-luong001.component.html',
  styleUrls: ['./plan-tham-dinh-detail-giam-sat-du-luong001.component.css']
})
export class PlanThamDinhDetailGiamSatDuLuong001Component implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PlanThamDinhDetailGiamSatDuLuong001Component>,
  ...
  PlanThamDinhDanhMucLayMauAdd(ID: number) {
    ...
    this.PlanThamDinhDanhMucLayMauService.GetByIDAsync().subscribe(
      res => {
        ...
        dialogConfig.width = environment.DialogConfigWidth;
        dialogConfig.data = { ID: ID };
        const dialog = this.dialog.open(PlanThamDinhDanhMucLayMauDetailGiamSatDuLuongComponent, dialogConfig);
        dialog.afterClosed().subscribe(() => {
          this.PlanThamDinhDanhMucLayMauSearch();
        });
        this.PlanThamDinhService.IsShowLoading = false;
