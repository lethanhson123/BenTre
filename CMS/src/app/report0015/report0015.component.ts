...
@Component({
  selector: 'app-report0015',
  templateUrl: './report0015.component.html',
  styleUrls: ['./report0015.component.css']
})
export class Report0015Component implements OnInit {
  ...
  Report0015Search() {
    ...
    this.ReportService.Report0015ToListAsync().subscribe(
      res => {
  ...
  Report0015Download() {
    ...
    this.DownloadService.ExportReport0015ToExcelAsync().subscribe(
      res => {
