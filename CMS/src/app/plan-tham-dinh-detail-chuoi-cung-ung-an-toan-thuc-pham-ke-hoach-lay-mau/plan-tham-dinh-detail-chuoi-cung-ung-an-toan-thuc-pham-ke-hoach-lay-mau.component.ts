...
@Component({
  selector: 'app-plan-tham-dinh-detail-chuoi-cung-ung-an-toan-thuc-pham-ke-hoach-lay-mau',
  templateUrl: './plan-tham-dinh-detail-chuoi-cung-ung-an-toan-thuc-pham-ke-hoach-lay-mau.component.html',
  styleUrls: ['./plan-tham-dinh-detail-chuoi-cung-ung-an-toan-thuc-pham-ke-hoach-lay-mau.component.css']
})
export class PlanThamDinhDetailChuoiCungUngAnToanThucPhamKeHoachLayMauComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PlanThamDinhDetailChuoiCungUngAnToanThucPhamKeHoachLayMauComponent>,
  ...
  PlanThamDinhDanhMucLayMauSearch() {
    ...
    this.PlanThamDinhDanhMucLayMauService.GetBySearchStringAndEmptyToListAsync().subscribe(
      res => {
        ...
        this.PlanThamDinhDanhMucLayMauService.DataSource = new MatTableDataSource(this.PlanThamDinhDanhMucLayMauService.ListDanhMucLayMau);
  ...
  PlanThamDinhDanhMucLayMauAdd(ID: number) {
    ...
    this.PlanThamDinhDanhMucLayMauService.GetByIDAsync().subscribe(
      res => {
        ...
        dialogConfig.width = environment.DialogConfigWidth;
        dialogConfig.data = { ID: ID };
        const dialog = this.dialog.open(PlanThamDinhDanhMucLayMauDetailChuoiCungUngAnToanThucPhamKeHoachLayMauComponent, dialogConfig);
        dialog.afterClosed().subscribe(() => {
          this.PlanThamDinhDanhMucLayMauSearch();
        });
        this.PlanThamDinhService.IsShowLoading = false;
