...
export class BaseService {
    ...
    constructor(
        ...
        this.BaseParameter = {
            ...
            SoThang: environment.InitializationNumber,
            DistrictDataID: environment.InitializationNumber,
            WardDataID: environment.InitializationNumber,
            DanhMucATTPTinhTrangID: environment.InitializationNumber,
            DanhMucATTPXepLoaiID: environment.InitializationNumber,
            DanhMucProductGroupID: environment.InitializationNumber,
            PlanTypeID: environment.InitializationNumber,
            PlanThamDinhID: environment.InitializationNumber,
    ...
    ComponentGetAllToListRefreshAsync() {
        this.IsShowLoading = true;
        this.GetAllToListAsync().subscribe(
            res => {
                this.List = (res as any[]).sort((a, b) => (a.SortOrder > b.SortOrder ? 1 : -1));
