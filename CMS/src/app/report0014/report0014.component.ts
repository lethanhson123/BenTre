...
@Component({
  selector: 'app-report0014',
  templateUrl: './report0014.component.html',
  styleUrls: ['./report0014.component.css']
})
export class Report0014Component implements OnInit {
  ...
  Report0014Search() {
    ...
    this.ReportService.Report0014ToListAsync().subscribe(
      res => {
  ...
  Report0014Download() {
    ...
    this.DownloadService.ExportReport0014ToExcelAsync().subscribe(
      res => {
