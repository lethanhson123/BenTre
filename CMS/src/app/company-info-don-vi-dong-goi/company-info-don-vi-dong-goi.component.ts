...
@Component({
  selector: 'app-company-info-don-vi-dong-goi',
  templateUrl: './company-info-don-vi-dong-goi.component.html',
  styleUrls: ['./company-info-don-vi-dong-goi.component.css']
})
export class CompanyInfoDonViDongGoiComponent implements OnInit {
