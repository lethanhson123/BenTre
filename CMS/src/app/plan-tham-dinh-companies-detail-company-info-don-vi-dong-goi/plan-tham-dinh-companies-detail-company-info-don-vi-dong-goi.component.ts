...
@Component({
  selector: 'app-plan-tham-dinh-companies-detail-company-info-don-vi-dong-goi',
  templateUrl: './plan-tham-dinh-companies-detail-company-info-don-vi-dong-goi.component.html',
  styleUrls: ['./plan-tham-dinh-companies-detail-company-info-don-vi-dong-goi.component.css']
})
export class PlanThamDinhCompaniesDetailCompanyInfoDonViDongGoiComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PlanThamDinhCompaniesDetailCompanyInfoDonViDongGoiComponent>,
  ...
  PlanThamDinhCompanyBienBanSearch() {
    this.PlanThamDinhCompaniesService.IsShowLoading = true;
    this.PlanThamDinhCompanyBienBanService.BaseParameter.DanhMucProductGroupID = 13;
  ...
  PlanThamDinhCompanyDocumentAdd001(DocumentTemplateID: number) {
    ...
    this.PlanThamDinhCompanyDocumentService.GetByParentID_DocumentTemplateIDAsync().subscribe(
      res => {
        ...
        this.PlanThamDinhCompanyDocumentService.FormData.CompanyInfoDonViDongGoiID = this.PlanThamDinhService.FormData.ID;
        const dialogConfig = new MatDialogConfig();
        dialogConfig.disableClose = true;
        dialogConfig.autoFocus = true;
        dialogConfig.width = environment.DialogConfigWidth;
  ...
  PlanThamDinhCompanyDocumentAdd() {
    if (this.PlanThamDinhCompanyBienBanService.BaseParameter.DanhMucProductGroupID > 0) {
      this.PlanThamDinhCompaniesService.IsShowLoading = true;
      this.PlanThamDinhCompanyDocumentService.BaseParameter.PlanTypeID = environment.PlanTypeIDDangKyMaDongGoi;
      this.PlanThamDinhCompanyDocumentService.BaseParameter.ParentID = this.PlanThamDinhCompaniesService.FormData.ID;
  ...
  CompanyInfoDonViDongGoiAdd(){
    this.PlanThamDinhCompaniesService.IsShowLoading = true;
    this.CompanyInfoDonViDongGoiService.BaseParameter.ID = this.PlanThamDinhCompaniesService.FormData.CompanyInfoDonViDongGoiID;
    this.CompanyInfoDonViDongGoiService.GetByIDAsync().subscribe(
      res => {
        ...
        dialogConfig.autoFocus = true;
        dialogConfig.width = environment.DialogConfigWidth;
        dialogConfig.data = { ID: this.CompanyInfoDonViDongGoiService.FormData.ID };
  ...
  PlanThamDinhCompaniesSave() {
    ...
    this.CompanyInfoDonViDongGoiService.GetByIDAsync().subscribe(
      res => {
        this.CompanyInfoDonViDongGoiService.FormData = res as CompanyInfoDonViDongGoi;
        this.CompanyInfoDonViDongGoiService.FormData.DanhMucATTPXepLoaiID = this.PlanThamDinhCompaniesService.FormData.DanhMucATTPXepLoaiID;
        this.CompanyInfoDonViDongGoiService.FormData.MaHoSo = this.PlanThamDinhCompaniesService.FormData.MaSo;
