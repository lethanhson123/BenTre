...
@Component({
  selector: 'app-plan-tham-dinh-danh-muc-lay-mau-detail-giam-sat-du-luong',
  templateUrl: './plan-tham-dinh-danh-muc-lay-mau-detail-giam-sat-du-luong.component.html',
  styleUrls: ['./plan-tham-dinh-danh-muc-lay-mau-detail-giam-sat-du-luong.component.css']
})
export class PlanThamDinhDanhMucLayMauDetailGiamSatDuLuongComponent implements OnInit {

  constructor(
    private dialog: MatDialog,
    public dialogRef: MatDialogRef<PlanThamDinhDanhMucLayMauDetailGiamSatDuLuongComponent>,
  ...
  CompanyInfoSearch() {
    ...
    this.CompanyInfoService.BaseParameter.PlanTypeID = environment.PlanTypeIDGiamSatDuLuong;
  ...
  CompanyInfoAdd() {
    ...
    this.CompanyInfoService.GetByIDAsync().subscribe(
      res => {
        ...
        this.CompanyInfoService.FormData.PlanTypeID = environment.PlanTypeIDGiamSatDuLuong;
