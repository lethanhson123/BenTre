...
@Component({
  selector: 'app-plan-tham-dinh-detail-company-info-don-vi-dong-goi',
  templateUrl: './plan-tham-dinh-detail-company-info-don-vi-dong-goi.component.html',
  styleUrls: ['./plan-tham-dinh-detail-company-info-don-vi-dong-goi.component.css']
})
export class PlanThamDinhDetailCompanyInfoDonViDongGoiComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PlanThamDinhDetailCompanyInfoDonViDongGoiComponent>,
  ...
  ThanhVienSearch() {
    this.ThanhVienService.BaseParameter.StateAgencyID = environment.StateAgencyIDChiCucBaoVeThucVat;
  ...
  CompanyInfoDonViDongGoiSearch() {
    ...
    this.CompanyInfoDonViDongGoiService.BaseParameter.DanhMucATTPTinhTrangID = 1;
    this.CompanyInfoDonViDongGoiService.BaseParameter.Active = true;
    this.CompanyInfoDonViDongGoiService.GetByDanhMucATTPTinhTrangID_ActiveToListAsync().subscribe(
      res => {
        this.CompanyInfoDonViDongGoiService.List = (res as CompanyInfoDonViDongGoi[]).sort((a, b) => (a.SortOrder > b.SortOrder ? 1 : -1));
        for (let i = 0; i < this.CompanyInfoDonViDongGoiService.List.length; i++) {
          this.CompanyInfoDonViDongGoiService.List[i].Active = false;
        }
        this.CompanyInfoDonViDongGoiService.DataSource = new MatTableDataSource(this.CompanyInfoDonViDongGoiService.List);
        this.CompanyInfoDonViDongGoiService.DataSource.sort = this.ATTPInfoSort;
        this.CompanyInfoDonViDongGoiService.DataSource.paginator = this.ATTPInfoPaginator;
  ...
  CompanyInfoDonViDongGoiActiveChange(element: CompanyInfoDonViDongGoi) {
    if (element.Active == true) {
      ...
      this.PlanThamDinhCompaniesService.FormData.CompanyInfoDonViDongGoiID = element.ID;
