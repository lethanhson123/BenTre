...
@Component({
  selector: 'app-plan-tham-dinh-chuoi-cung-ung',
  templateUrl: './plan-tham-dinh-chuoi-cung-ung.component.html',
  styleUrls: ['./plan-tham-dinh-chuoi-cung-ung.component.css']
})
export class PlanThamDinhChuoiCungUngComponent implements OnInit {
