...
@Component({
  selector: 'app-plan-tham-dinh-danh-muc-lay-mau-detail-nhuyen-the-hai-manh-vo',
  templateUrl: './plan-tham-dinh-danh-muc-lay-mau-detail-nhuyen-the-hai-manh-vo.component.html',
  styleUrls: ['./plan-tham-dinh-danh-muc-lay-mau-detail-nhuyen-the-hai-manh-vo.component.css']
})
export class PlanThamDinhDanhMucLayMauDetailNhuyenTheHaiManhVoComponent implements OnInit {

  constructor(
    private dialog: MatDialog,
    public dialogRef: MatDialogRef<PlanThamDinhDanhMucLayMauDetailNhuyenTheHaiManhVoComponent>,
  ...
  CompanyInfoSearch() {
    ...
    this.CompanyInfoService.BaseParameter.PlanTypeID = environment.PlanTypeIDNhuyenTheHaiManhVo;
  ...
  CompanyInfoAdd() {
    ...
    this.CompanyInfoService.GetByIDAsync().subscribe(
      res => {
        ...
        this.CompanyInfoService.FormData.PlanTypeID = environment.PlanTypeIDNhuyenTheHaiManhVo;
